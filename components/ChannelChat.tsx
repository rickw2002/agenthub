...
export default function ChannelChat({ provider }: ChannelChatProps) {
    ...
    <div className="flex flex-col h-96">
        ...
        {messages.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-gray-500 text-sm">
              Stel een vraag over dit kanaal en ik help je verder!
            </p>
          </div>
        ) : (
      ...
      <form onSubmit={handleSend} className="mt-4 flex gap-2">
        <input
          ...
          placeholder="Stel een vraag over dit kanaal..."
